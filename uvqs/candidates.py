...
def get_nuv_cand(outfil=None, known_fil=None):
    ...
    '''
    #  Read photometry
    z1_galex_nuv, z1_wise_nuv = z1qc.load_phot(use_NUV=True)
    ...
    # Check against z1QSO 
    cut_z1qso = z1qa.new_z1qso() # z1QSO with good z, not in milliq
    ...
    milliq = z1qa.load_milliq(good_z=True, good_FUV=True) 
